...
def make_datasets(config):
    ...
    # done
        ...
        train_dataset = Kitti360Dataset(
            ...
            data_depth_path=config.get("data_depth_path", None),
            data_depth_std_path=config.get("data_depth_std_path", None),
            data_normal_path=config.get("data_normal_path", None),
            pose_path=config["pose_path"],
            ...
            depth_mode=config.get("depth_mode", None),
            normal_mode=config.get("normal_mode", None),
            keyframe_offset=config.get("keyframe_offset", 0),
            dilation=config.get("dilation", 1),
